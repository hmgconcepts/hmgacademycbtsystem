...
const CBTChatbot = {
  ...
  FALLBACK_GUIDES: {
    ...
    /*BUILDER-ONLY*/    'client-monitor.html': { title: '📡 Client Monitor', who: 'Platform owner (HMG / builder)', summary: 'Register client deployments and watch their live subscription status; generate registry overrides.' },/*BUILDER-ONLY-END*/
    ...
    /*BUILDER-ONLY*/    'license.html':    { title: '📜 License Console', who: 'Owner', summary: 'Subscription lifecycle, quick-extend, offline perpetual token. Always reachable even when the portal is locked.' },/*BUILDER-ONLY-END*/
  ...
  kb: [
    ...
    /*BUILDER-ONLY*/'\n• **Builder\'s own deployment only:** the License console (license.html — owner-only) shows full status + the offline HMAC perpetual token and can quick-extend +30/+90/+365 days; the hosted registry always wins over local values, and client deployments have no license console by design.'/*BUILDER-ONLY-END*/ },
    ...
    /*BUILDER-ONLY*/' · 📡 Client Monitor · 📜 License'/*BUILDER-ONLY-END*/ +
    ...
    /*BUILDER-ONLY*/'\n• **Owners:** License console for subscriptions + 📡 Client Monitor to watch client deployments; Generator (separate product) to build new client platforms'/*BUILDER-ONLY-END*/ +
  ...
  buildQuickQuestions() {
    ...
    /*BUILDER-ONLY*/else if (pageId === 'license.html' || pageId === 'client-monitor.html') pageSpecific = ['Subscription expired — what now?', 'How do I renew/extend?'];/*BUILDER-ONLY-END*/
